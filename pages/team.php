...
<html lang="en">
    ...
    <head>
        ...
        <!-- Title -->
        <title> Equipe </title>
        <link rel="shortcut icon" href="./../img/title-people-group.svg"/>
...
<main>
    ...
    <nav>
        <div class="container">
            ...
            <ul>
                <li><a href="./../index.php"><i class="fa-solid fa-house"></i><span class="ocult-line">-</span> Início </a></li>
                <li><a href="articles.php"><i class="fa-solid fa-newspaper"></i><span class="ocult-line">-</span> Artigos </a></li>
                <li><a href="account.php"><i class="fa-solid fa-bullhorn"></i><span class="ocult-line">-</span> Denuncie </a></li>
                <li><a href="#"><i class="cab fa-solid fa-people-group"></i><span class="ocult-line">-</span> Equipe </a></li>
            </ul>
        </div>
    </nav>
    ...
    <div class="header-body">
        <div class="container">
            ...
            <div class="slider">
                <div>   
                    <h1 class="slider-count" id="representatives"> Representantes </h1>
                    <br>
                ...
                <div class="container-card">
                    <div class="card">
                        <div class="top-bar"></div>
                            ...
                            <div class="photo">
                                <img alt="img" class="img" src="./../img/Card-Bruno.png">
                            ...
                            <h6>
                                ...
                                <span class="tri-title"> front end developer </span>
                            </h6>
                        ...
                        <div class="socialy"> 
                            ...
                            <a href="#"><i class="ins uil uil-instagram-alt"></i></a>
